...
function cadastrar(req, res) {
    ...
    var numEndereco = req.body.numEnderecoVar;
    ...
    if (estado == undefined) {
        ...
        res.status(400).send("Seu numero de endereço está undefined!");
        ...
        enderecoModel.cadastrar(estado, cidade, cep, numEndereco, logradouro, complemento)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
